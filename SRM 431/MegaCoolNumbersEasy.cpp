...
// CUT begin
ifstream data("MegaCoolNumbersEasy.sample");
...
bool do_test(int N, int __expected) {
    ...
    MegaCoolNumbersEasy *instance = new MegaCoolNumbersEasy();
...
int main(int argc, char *argv[]) {
    ...
    if (mainProcess) {
        cout << "MegaCoolNumbersEasy (250 Points)" << endl << endl;
    }
